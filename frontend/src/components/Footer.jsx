const Footer = () => {
    return (
        <div id="footer" className="bg-gray-100 py-8 px-4 flex flex-col lg:flex-row lg:justify-center items-center lg:items-start max-w-full mx-auto">
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left mb-8 lg:mb-0 px-28">
            ...
            <div className="flex flex-col items-center lg:items-start text-center lg:text-left px-28">
