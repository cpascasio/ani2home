    ...
    <div style={{ backgroundColor: "#e5e7eb" }} className="w-full pt-24">
      <div className="px-5 sm:px-10 md:px-20 lg:px-40 bg-gray-200 min-h-screen">
        ...
        <div className="flex justify-center mt-10 mb-10">
          ...
          <div className="bg-white max-w-[600px] p-6 flex flex-col justify-between relative">
            {" "}
            {/* Set flex column layout and adjust width */}
            <div>
              ...
              <div className="mt-4 ml-5 font-inter text-[15px] text-black text-left">
                We’ll message you an order confirmation with details and
                tracking info.
              </div>
            </div>
            <div className="flex justify-center mt-7 mb-4">
              {" "}
              {/* Center button horizontally and add margin bottom */}
              <button
