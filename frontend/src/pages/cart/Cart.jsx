...
import carrotImage from '../../assets/carrot.png'; // make sure the path to the image is correct
...
const Cart = () => {
    const unitPrice = 695.00; // Set unit price here
        ...
        <div className='w-full'>
            ...
            <div className="px-40 bg-gray-200"> {/* main container for body */}
                ...
                <div className="bg-white w-[1225px] h-[133px] mt-4 flex items-center p-4 relative"> {/* white box */}
                    <img src={carrotImage} alt="Product" className="w-[100px] h-[100px]" /> {/* product image */}
