      ...
      <Header />
        <div className="flex w-full h-auto bg-gradient-to-r from-green-900"> {/*banner */}
            ...
            <div className="px-40 bg-gray-200"> {/*main container for body*/}
                <div className="py-4 flex"> {/* Main div with left and right child divs */}
                    <div className="w-40% pr-40 pt-10"> {/* Left div */}
                        <div className="text-l font-bold mb-2 text-gray-600 pb-5">USER PROFILE</div>
                        <ul className="space-y-4 text-left">
                            <li>
                                <a href="#" className="text-gray-600 hover:text-blue-500 hover:underline">My Profile</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-600 hover:text-blue-500 hover:underline">My Orders</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-600 hover:text-blue-500 hover:underline">My Shop</a>
                            </li>
                        </ul>
                    </div>
                    <div className="flex-1 pt-10"> {/* Right div */}
